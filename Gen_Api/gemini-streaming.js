...
dotenv.config();
import readline from "readline"; //import readline for reading 
import { GoogleGenerativeAI } from "@google/generative-ai"; // Corrected spelling
...
let isAwaitingResponse = false; //Flag to indicate if we're awaiting response
